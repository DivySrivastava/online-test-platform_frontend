...
const ALL_DATA = [
  { id: 1, instId: "INST001", name: "SBSSU", city: "Rajasthan, Jaipur", reg: "Yes" },
  { id: 2, instId: "INST002", name: "Delhi Public School", city: "Delhi, New Delhi", reg: "Yes" },
  { id: 3, instId: "INST003", name: "IIT Bombay", city: "Maharashtra, Mumbai", reg: "Yes" },
  { id: 4, instId: "INST004", name: "St. Xavier College", city: "Gujarat, Ahmedabad", reg: "No" },
  { id: 5, instId: "INST005", name: "Amity University", city: "UP, Noida", reg: "Yes" },
  { id: 6, instId: "INST006", name: "Christ University", city: "Karnataka, Bengaluru", reg: "No" },
  { id: 7, instId: "INST007", name: "Presidency College", city: "West Bengal, Kolkata", reg: "Yes" },
  { id: 8, instId: "INST008", name: "Symbiosis Institute", city: "Maharashtra, Pune", reg: "Yes" },
  { id: 9, instId: "INST009", name: "Jadavpur University", city: "West Bengal, Kolkata", reg: "Yes" },
  { id: 10, instId: "INST010", name: "NIT Trichy", city: "Tamil Nadu, Trichy", reg: "Yes" },
  { id: 11, instId: "INST011", name: "BHU Varanasi", city: "UP, Varanasi", reg: "No" },
  { id: 12, instId: "INST012", name: "Miranda House", city: "Delhi, New Delhi", reg: "Yes" },
  { id: 13, instId: "INST013", name: "BITS Pilani", city: "Rajasthan, Pilani", reg: "Yes" },
  { id: 14, instId: "INST014", name: "Loyola College", city: "Tamil Nadu, Chennai", reg: "No" },
  { id: 15, instId: "INST015", name: "IIM Ahmedabad", city: "Gujarat, Ahmedabad", reg: "Yes" },
  { id: 16, instId: "INST016", name: "Fergusson College", city: "Maharashtra, Pune", reg: "Yes" },
  { id: 17, instId: "INST017", name: "St. Stephen's", city: "Delhi, New Delhi", reg: "Yes" },
  { id: 18, instId: "INST018", name: "Calcutta University", city: "West Bengal, Kolkata", reg: "No" },
  { id: 19, instId: "INST019", name: "VIT Vellore", city: "Tamil Nadu, Vellore", reg: "Yes" },
  { id: 20, instId: "INST020", name: "Anna University", city: "Tamil Nadu, Chennai", reg: "Yes" },
];
...
function Manageinstitutes() {
  ...
  const labelEnd = totalRecords ? Math.min(currentPage * pageLimit, totalRecords) : 0;
  ...
  const handleViewStandards = async (instituteId, instituteType) => {
    try {
      ...
      setStandardTitle(instituteType === "School"
        ? "Standards"
  ...
  const handleApply = () => {
    let r = ALL_DATA;
    if (stateVal !== "All") r = r.filter(i => i.city.split(",")[0].trim() === stateVal);
    if (cityVal !== "All") r = r.filter(i => i.city.split(",")[1]?.trim() === cityVal);
        ...
        >
          ...
          <div className="f-row">
            ...
            <select value={typeVal} onChange={e => setTypeVal(e.target.value)}>
              {["All", "School", "College", "University", "Coaching"].map(o => <option key={o}>{o}</option>)}
            </select>
          </div>
          ...
          <button className="f-btn" onClick={handleSearch}>Search</button>

          <p className="f-clear" onClick={handleClear}>Clear Search & Filter</p>
        ...
        <div className="main-content">
          ...
          <div className="institute-header">
            ...
            <div className="mob-filter-bar">
              <button className="mob-filter-btn" ref={buttonRef} onClick={toggleFilter}>
          ...
          <div className="table-wrap">
            <table className="inst-table">
              ...
              <tbody>
                {rows.length === 0 ? (
                  <tr><td colSpan="7" className="no-data">No institutions found.</td></tr>
                ) : (
                  rows.map((row, idx) => (
                    <tr key={row.id}>
                      ...
                      <td>{row.institute_city},{row.institute_state}</td>
                      ...
                      <td>
                        <FaEye
                          ...
                          onClick={() =>
                            handleViewStandards(row.institute_id, row.institute_type)
                          }
                        />
                      </td>
                    </tr>

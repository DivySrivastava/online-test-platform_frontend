...
const ManageUsers = () => {
  ...
  //Fetch Admin Count
  useEffect(() => {
      axios.get(`${API_URL}/user/get-user-count`)
  ...
  // 🔹 Tiles
  const tiles = [
    { id: 1, title: 'Create Admin', description: 'Add New Member as an Admin', icon: 'admin.png' },
    { id: 2, title: 'Show Users', description: 'To see all type of users', icon: 'group.png' },
    { id: 3, title: 'Pending Request', description: 'To get Information about pending requests', icon: 'pending.png' }
  ];

  // 🔹 Sidebar Menu
  const menuItemsByRole = [
    { id: 1, title: 'Dashboard', pagename: 'dashboard', icon: 'home.png' },
    { id: 2, title: 'Manage Users', pagename: 'Manageusers', icon: 'group.png' },
    { id: 3, title: 'Total Quizzes', pagename: 'totalquizzes', icon: 'quiz.png' },
    { id: 4, title: 'Active Quizzes', pagename: 'activequizzes', icon: 'planning.png' },
    { id: 5, title: 'Create Quiz', pagename: 'createquiz', icon: 'edit.png' },
    { id: 6, title: 'Total Institutions', pagename: 'totalinstitutions', icon: 'school.png' },
    { id: 7, title: 'Test Details', pagename: 'testdetails', icon: 'report.png' }
  ];
      ...
      <div className='main-manageuser-section'>
        ...
        <div className='mnguser-mgt-grid'>
          <div className='mnguser-mgt'>
            <img src="/images/admin.png" alt="Admins" className='mnguser-icon' />
            <h2>Admins</h2>
            <p>{userCounts.total_admins}</p>
          </div>  

          <div className='mnguser-mgt'>
            <img src="/images/teacher.png" alt="Teachers" className='mnguser-icon' />
            <h2>Teachers</h2>
            <p>{userCounts.total_teachers}</p>
          </div>

          <div className='mnguser-mgt'>
            <img src="/images/student.png" alt="Students" className='mnguser-icon' />
            <h2>Students</h2>
            <p>{userCounts.total_students}</p>
          </div>

          <div className='mnguser-mgt'>
            <img src="/images/student.png" alt="Users" className='mnguser-icon' />
            <h2>Normal Users</h2>
